...
create_status_message :author => @aitana,
                      :area => Area.find(3),
                      :message => 'Inaugurando el nuevo polideportivo en San Sebastian.'
...
create_status_message :author => @aitor,
                      :area => Area.find(3),
                      :message => 'Nuevo Centro de Salud, otra promesa cumplida.'
...
create_status_message :author => @javier,
                      :area => Area.find(3),
                      :message => 'Éxito en las Conferencias sobre Biodiversidad de la Universidad de Deusto.'

create_status_message :author => @javier,
                      :area => Area.find(3),
                      :message => 'De camino a Madrid para reunirme con el Consejero de Educación.'
