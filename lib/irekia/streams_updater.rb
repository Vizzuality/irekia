  ...
  module StreamsUpdater
    ...
    def update_streams(content_or_participation = nil)
      ...
      if item.just_created?
        ...
        values  = item.to_update_public_streams.select{|item| item.is_a?(User)}.map{|user| [user.id, data_for_streams.event_id, data_for_streams.event_type, data_for_streams.author_id, data_for_streams.published_at, data_for_streams.moderated, data_for_streams.message]}.uniq
        ...
        values  = item.to_update_public_streams.select{|item| item.is_a?(Area)}.map{|area| [area.id, data_for_streams.event_id, data_for_streams.event_type, data_for_streams.author_id, data_for_streams.published_at, data_for_streams.moderated, data_for_streams.message]}.uniq
