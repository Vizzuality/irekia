...
create_news :title        => 'San Sebastián es elegida capital europea de la cultura en 2016',
            ...
            :body         => (<<-EOF
              San Seba    stián ha sido elegida Capital Europea de la Cultura 2016 junto a la ciudad polaca de Wroclaw. San Sebastián se impone así sobre la que sonaba como favorita, Córdoba, y a otras cuatro candidatas: Burgos, Segovia, Las Palmas y Zaragoza. San Sebastián afronta esta designación en un contexto de incertidumbre política por el reciente cambio en el equipo de Gobierno municipal, que ha pasado a manos de Bildu. En los actos finales de presentación del proyecto de la capital guipuzocana han participado conjuntamente el exalcalde socialista, Odón Elorza, y el nuevo alcalde, Juan Karlos Izagirre. "Zorionak Donostia. Zorionak Euskadi Entre todos lo hemos conseguido", ha señalado el lehendakariPatxi López a través de su perfil en la red social Twitter.
            EOF
            ),
            :image        => File.open(Rails.root.join('db/seeds/support/images/news_1.jpg')),
            :tags         => %w(capital\ europea cultura san\ sebastian).join(','),
            :author       => @aitana,
            :users_tagged => [User.politicians.sample],
            :comments     => [
                      ...
                      create_comment(@patricia, 'Me enteré tarde de la noticia, pero me alegré mucho!!! Conozco a gente que ha trabajado en el diseño del logo y me hace mucha ilu verlo en periodicos y paginas web')
                    ]
...
La popularísima prueba     pedestre de la Behobia-San Sebastián se sale del calendario nacional establecido por la Real Federación Española de Atletismo por su desacuerdo y disconformidad con el reglamento que obliga a los organizadores a pagar un canon de tres euros por atleta participante. De esta manera, la Behobia no podrá contar con atletas becados por el ente federativo ya que estos no pueden disputar carreras que no estén en el programa oficial de competición.
La consecuencia más di    recta de esta decisión del Fortuna repercute a dos atletas profesionales asiduos a este circuito guipuzcoano, el madrileño Chema Martínez –cuatro veces ganador– y el salmantino Rafa Iglesias, vencedor de las dos últimas ediciones.
            EOF
            ),
...
create_news :title        => 'La Fundación Bilbao 700 inicia este jueves una nueva edición del ciclo de música barroca en el teatro Campos',
            ...
            :body         => (<<-EOF
El ciclo 'Bilbao Estac    ión Barroca', organizado por la Fundación Bilbao 700-III Millenium en colaboración con Arteria Campos Elíseos, iniciará este jueves una nueva temporada de conciertos, que se prolongará hasta el día 25 de noviembre y ofrecerá "cuatro producciones a cargo de destacadas formaciones y solistas que, en los últimos años, han actualizado este estilo musical con un enfoque original y novedoso".
...
Junto a solistas de "p    rimer nivel", estas formaciones interpretarán algunas de las obras de los grandes compositores del barroco italiano, francés y español, según han explicado sus organizadores.
            EOF
            ),
            :image        => File.open(Rails.root.join('db/seeds/support/images/news_3.jpg')),
            :tags         => %w(teatro cultura musica).join(','),
            :author       => @aitor,
            :areas_tagged => [@area],
            :comments     => [
...
Según han informado lo    s organizadores, junto a la competición de sumilleres, se celebrará la Nariz de Oro Experimenta, un espacio gastronómico abierto al público en el que los asistentes podrán aprender a crear tapas, cócteles e incluso a manejar el arte de cortar jamón.
La cita será la primer    a semifinal de la competición y tras ella, la Nariz de Oro viajará a Santiago, Valencia, Barcelona, Madrid y Málaga en busca de los sumilleres que representarán a sus respectivas zonas en la final.
            EOF
            ),
            :image        => File.open(Rails.root.join('db/seeds/support/images/news_4.jpg')),
            :tags         => %w(vino sumiller evento).join(','),
            :author       => @aitor,
            :users_tagged => [User.politicians.sample],
            :comments     => [
...
create_news :title        => 'El Gobierno Vasco aprueba los Presupuestos generales para 2010.',
            ...
            :body         => (<<-EOF
Controvertidos y delic    ados. Los Presupuestos para el 2010 -los sextos de la era Zapatero- han sido aprobados por el Gobierno en Consejo de Ministros extraordinario -provocado por el viaje a la Asamblea General de la ONU del presidente del Ejecutivo y de la vicepresidenta segunda, Elena Salgado- celebrado este sábado en Madrid. La vicepresidenta Fernández De la Vega ha calificado las nuevas cuentas generales de "realistas", "solidarias" y "equitativas"
La vicepresidenta Prim    era del Gobierno, María Teresa Fernández de la Vega, ha sido la primera en intervenir en rueda de prensa. De la Vega ha dicho que los Presupuestos para el próximo año son "austeros" debido a la "difícil coyuntura económica". Son "Presupuestos" para "la reactivación de una economía sostenible y la reactivación del empleo".
            EOF
            ),
            :image        => File.open(Rails.root.join('db/seeds/support/images/news_5.jpg')),
            :tags         => %w(presupuesto politica economía).join(','),
            :author       => @aitana,
            :users_tagged => [User.politicians.sample],
            :comments     => [
