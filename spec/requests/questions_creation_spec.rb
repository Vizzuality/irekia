...
describe "Questions creation" do
  ...
  it "shows a list of similar questions to the one being created" do
    ...
    response.body.should be == [
      {
        "author"=>{"id"=>7, "name"=>"María González Pérez", "profile_image"=>"/uploads/image/image/6/thumb_woman.jpeg"},
        ...
        "target_user"=>{"id"=>2, "name"=>"Alberto de Zárate López"},
        "answered_at"=>nil,
        "comments_count"=>0
      },
      {
        "author"=>{"id"=>7, "name"=>"María González Pérez", "profile_image"=>"/uploads/image/image/6/thumb_woman.jpeg"},
        "published_at"=>"2011-08-03T10:00:08Z",
        "question_text"=>"¿Cuándo va a ser efectiva la ayuda para estudiantes universitarios en 2011?",
        "target_user"=>{"id"=>3, "name"=>"Virginia Uriarte Rodríguez"},
        "answered_at"=>nil, "comments_count"=>1
      },
      {
        "author"=>{"id"=>7, "name"=>"María González Pérez", "profile_image"=>"/uploads/image/image/6/thumb_woman.jpeg"},
        "published_at"=>"2011-08-03T10:00:08Z",
        ...
        "target_user"=>nil,
        "answered_at"=>"2011-08-03T10:00:08Z",
        "comments_count"=>0
      },
      {
        "author"=>{"id"=>7, "name"=>"María González Pérez", "profile_image"=>"/uploads/image/image/6/thumb_woman.jpeg"},
