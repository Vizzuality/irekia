class AreasController < ApplicationController
  ...
  def get_area
    self.class.benchmark("Getting area...") do
  ...
  def get_area_data
    self.class.benchmark("Getting area data...") do
  ...
  def get_counters
    self.class.benchmark("Getting counters...") do
  ...
  def get_actions
    self.class.benchmark("Getting actions...") do
  ...
  def get_questions
    self.class.benchmark("Getting questions...") do
  ...
  def get_proposals
    self.class.benchmark("Getting proposals...") do
  ...
  def get_agenda
    self.class.benchmark("Getting agenda...") do
