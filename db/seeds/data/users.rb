...
@aitana = create_user :name                  => 'Aitana',
                      ...
                      :area_user             => AreaUser.create(:area  => Area.find(3), :display_order => 1),
...
@aitor = create_user :name                  => 'Aitor',
                     ...
                     :role                  => Role.find_by_name('Politician'),
                     :area_user             => AreaUser.create(:area  => Area.find(3), :display_order => 2),
...
@ainara = create_user :name                  => 'Ainara',
                      ...
                      :role                  => Role.find_by_name('Politician'),
                      :area_user             => AreaUser.create(:area  => Area.find(3)),
