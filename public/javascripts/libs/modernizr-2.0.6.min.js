...
window.Modernizr = (function(window, document, undefined) {
  ...
  var testBundle = (function(styles, tests) {
    ...
    injectElementWithStyles(style, function(node, rule) {
      ...
      /*>>touch*/
      Modernizr['touch'] = ('ontouchstart' in window) || (hash['touch'] && hash['touch'].offsetTop) === 9; /*>>touch*/
      /*>>csstransforms3d*/
      Modernizr['csstransforms3d'] = (hash['csstransforms3d'] && hash['csstransforms3d'].offsetLeft) === 9; /*>>csstransforms3d*/
      /*>>generatedcontent*/
